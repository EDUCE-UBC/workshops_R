...
This workshop assumes some prior experience with R (such as that in our [Introduction to R workshop](https://github.com/EDUCE-UBC/workshops_R/tree/main/intro_R_2hr)). It is also beneficial to have experience with the R tidyverse, such as that in our [workshop](https://github.com/EDUCE-UBC/workshops_R/tree/main/intro_tidyverse), and to have a basic working knowledge of Unix command line.
...
Now that the data are downloaded on your computer, you must load them into the current R project. We also will perform a little data cleaning and formatting on these data using functions in the tidyverse. If you are unfamiliar with these packages, please see our [R tidyverse workshop](https://github.com/EDUCE-UBC/workshops_R/tree/main/intro_tidyverse).
...
Here, we download the script from the [GitHub](https://github.com/EDUCE-UBC/workshops_R/blob/main/phylogenetics/scripts/BDTT_functions.R) and then load it into R with `source()`.
...
download.file(
  "https://github.com/EDUCE-UBC/workshops_R/blob/main/phylogenetics/results/pf_depth_F.RDS?raw=true",
...
```{r echo=FALSE, message=FALSE}
download.file(
  "https://github.com/EDUCE-UBC/workshops_R/blob/main/phylogenetics/results/pf_depth_var.RDS?raw=true",
...
```{r echo=FALSE, message=FALSE}
download.file(
  "https://github.com/EDUCE-UBC/workshops_R/blob/main/phylogenetics/results/pf_O2_var.RDS?raw=true",
...
download.file(
  "https://github.com/EDUCE-UBC/workshops_R/blob/main/phylogenetics/results/pf_NO3_var.RDS?raw=true",
