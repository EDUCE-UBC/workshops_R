...
- Input to output 
- Using a common language between user and computer 

![](Pictures_Doc_PROF/Step1.jpg)


### Theory : Why is this important? Why not using excel instead? 

![](Pictures_Doc_PROF/Step2.jpg)
...
![](Pictures_Doc_PROF/new.project1.png){width=50%}
/ 
...
![Figure 1. Introduction to R data frame](Pictures_Doc_PROF/DataFrame.png)
/ 
...
## Access some element of a dataframe
