...
### Theory : flow of actions

1. Input is raw data (e.g. an excel file)
2. Import in R
3. Transform/Calculus using basics operation and functions (a set of basic operations)
4. Visualize and Export (e.g. plot) 

### Theory : Why is this important? Why not using excel instead? 

* Its Open (i.e. you can modify and re-use code) and cross platform 
* Its free 
* It has a lot of “packages”, i.e. a lot of functions, “multifunctionality” 
...
3. Try a few different simple mathematical operations
...
## Detailled Overview of the workshop
...
Note - Generally, if you are testing an operation (*e.g.* what would my data look like if I applied a log-transformation to it?), 
...
# R coding: importing, manipulating and exporting objects
