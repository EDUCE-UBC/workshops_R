...
author: |
  ...
  | U. of British Columbiadate: "version `r format(Sys.time(), '%B %d, %Y')`"
output:
  html_document:
    df_print: paged
    toc: yes
...
1. Discuss with following in pairs
    - What are some advantages and disadvantages of using a balanced experimental design? 
        * __Advantages__: the test will have larger statistical power; _t_-test statistic is less susceptible to small departures from the assumption of equal variances (homoscedasticity)
        * __Disadvantages__: forced removal of relevant data to acheive balance 
